...
**注意**: 此章节定义的格式规范应与 `.markdownlint.json` 配置保持一致。
...
- 所有代码块必须指定语言标签（如 ````python`、````typescript`）
- 使用标准的语言标识符（参考 GitHub Flavored Markdown）
...
- IDE 层规则：`01-general.md`、`02-testing.md` 等
- 项目层规则：`01-react-basics.md`、`02-python-fastapi.md` 等
